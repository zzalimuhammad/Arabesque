...
namespace WebUI {
    ...
    private:
        ...
        static Error showFwInfo(const char* parameter, AuthenticationLevel auth_level, Channel& out) {  // ESP800
            ...
            LogStream s(out, "FW version: Arabesque ");
            s << git_info;
    ...
    public:
        ...
        void init() {
            ...
            _hostname    = new HostnameSetting("Hostname", "ESP112", "Hostname", "arabesque");
            ...
            _ap_ssid     = new StringSetting("AP SSID", WEBSET, WA, "ESP105", "AP/SSID", "Arabesque", MIN_SSID_LENGTH, MAX_SSID_LENGTH);
